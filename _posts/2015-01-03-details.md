...
**You'll learn:** In this course, we follow a complete workflow starting with the use of Subject Registry, followed by LabKey, and finally Spotfire. For more information, please visit the LabKey wiki at http://neurowiki.camh.ca/mediawiki/index.php/LabKey
...
**You'll learn:** In this course, we follow a complete workflow starting with the use of Subject Registry, followed by XNAT, and finally Spotfire. For more information, please visit the XNAT wiki at http://neurowiki.camh.ca/mediawiki/index.php/XNAT .
