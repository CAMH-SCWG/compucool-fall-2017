...
**Description:**  The class will cover basic pipeline of pre-alignment QC of FASATQ files, read alignments to the reference genome, Post alignment visualization using IGV, and differential expression analysis using R. If time permits, enrichment analysis using GSEA will also be covered.
