...
**Description:** LabKey enables tracking of genomics and other "omics" workflows, and managing and sharing resulting datasets.In this course, we follow a complete workflow starting with the use of Subject Registry, followed by LabKey, and finally Spotfire. For more information, please visit the LabKey wiki at http://neurowiki.camh.ca/mediawiki/index.php/LabKey
...
<div class="card-body" markdown="1">
*<font color = "purple">Note: This workshop is also offered on Thursday Oct 28th, 1-3pm</font>*
...
<div class="card-body" markdown="1">
**Instructors:** Marcia <br>

**Description:** XNAT is a comprehensive database for the storage and management of medical imaging data including MRI, PET, EEG, CT, as well as other types of binary data such as gait measures and pathology. In this course, we follow a complete workflow starting with the use of Subject Registry, followed by XNAT, and finally Spotfire. For more information, please visit the XNAT wiki at http://neurowiki.camh.ca/mediawiki/index.php/XNAT .
